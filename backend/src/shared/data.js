...
const db = {
  ...
  businessKpiConfigs: [
    { id: 1, code: "gmv", name: "GMV", targetValue: 12000, refreshInterval: 300, status: "active" },
    { id: 2, code: "activity_conversion", name: "活动转化率", targetValue: 35, refreshInterval: 300, status: "active" },
    { id: 3, code: "repeat_rate", name: "复购率", targetValue: 28, refreshInterval: 600, status: "active" }
  ],
  books: [
