...
const routes = [
  ...
  { path: "/shop/:productId", name: "productDetail", component: () => import("@/views/ProductDetail.vue") },
  ...
  { path: "/tasks", name: "tasks", component: () => import("@/views/TaskCenter.vue"), meta: { requiresAuth: true } },
  { path: "/invite", name: "invite", component: () => import("@/views/InviteGift.vue"), meta: { requiresAuth: true } },
  { path: "/badges", name: "badges", component: () => import("@/views/BadgeWall.vue"), meta: { requiresAuth: true } },
  ...
  { path: "/pay/:orderId", name: "pay", component: () => import("@/views/Payment.vue"), meta: { requiresAuth: true } },
  { path: "/payment/:orderId", redirect: (to) => `/pay/${to.params.orderId}` },
